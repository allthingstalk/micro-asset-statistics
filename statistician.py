...
class Statistician:
    ...
    def __init__(self, name, functions, resetEvery, asset):
        ...
        for function in functions:
            ...
            if name == "dist" or name == "distsumtime":
                if "min" not in self._functions:
                    self._functions['min'] = None
                if "max" not in self._functions:
    ...
    def createAssets(self, context):
        ...
        if "distsumtime" in self._functions:
            ...
            Virtual.create(context, self._asset.device, self.getAssetName('distsumtimeprev'),
                           self.getAssetLabel('dist-sum-time-prev'), "generated by the statistician",
                           {"type": "object", "properties": { "value": self._asset.profile, "timestamp": {"type": "string"}}})
